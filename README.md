...
1. Inside your `burger` directory, create a folder named `public`.
   ...
   * Create the `index.html` file inside `public` directory.

     * Setup the `index.html` to have the template that Handlebars can render.

     * Create a button in `index.html` that will submit the user input into the database.
